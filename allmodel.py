...
olddata =pd.read_excel (r'C:\Users\OhoMindZa\Documents\jan-pro\part-ml\dlspot-code\data-file\136hr_dataset.xlsx', sheet_name='old')
...
df_filter = pd.DataFrame(data_1hr, columns= ['Humidity'	,'Object(*C)','CO2Analog(ppm)',
                        'CO2PWM(ppm)',	'isGood','Xbar_Humidity_1hr',	'Xbar_Vis_1hr',	
                        'Xbar_UVindex_1hr',	'Xbar_Object(*C)_1hr',	'Xbar_co2analog_1hr',	
                        'SD_Humidity_1hr'	,'SD_Vis_1hr'	,'SD_UVindex_1hr', 'SD_Object(*C)_1hr',	'SD_co2analog_1hr'])

df_filter_3hr = pd.DataFrame(data_3hr, columns= ['Humidity'	,'Object(*C)','CO2Analog(ppm)',
                        'CO2PWM(ppm)',	'isGood','Xbar_Humidity_3hr',	'Xbar_Vis_3hr',	
                        'Xbar_UVindex_3hr',	'Xbar_object_3hr',	'Xbar_co2analog_3hr',	
                        'SD_Humdity_3hr',	'SD_Vis_3hr',	'SD_UVindex_3hr','SD_object(*C)_3hr',	'SD_co2analog_3hr'])

df_filter_6hr = pd.DataFrame(data_6hr, columns= ['Humidity'	,'Object(*C)','CO2Analog(ppm)',
                        'CO2PWM(ppm)',	'isGood','Xbar_Humidity_6hr'	,'Xbar_Vis_6hr'	,
                        'Xbar_UVindex_6hr',	'Xbar_object_6hr',	'Xbar_co2analog_6hr','SD_Humidity_6hr',
                    	'SD_Vis_6hr',	'SD_UVindex_6hr',	'SD_Object(*C)_6hr','SD_CO2Analog(ppm)_6hr'])
...
data_norm = normalize(olddata)  #### edit here to change data to norm
...
print('ค่า Accuracy with SVM 3hr data :',acc_svm_3)
...
print('ค่า Accuracy with SVM 6hr data :',acc_svm_6)
