...
plt.plot(no_neighbors, test_accuracy_1hr, label = '1-hr Accuracy')
plt.plot(no_neighbors, test_accuracy_3hr, label = '3-hr Accuracy')
plt.plot(no_neighbors, test_accuracy_6hr, label = '6-hr Accuracy')
plt.legend()
plt.xlabel('Number of Neighbors')
plt.ylabel('Accuracy')
plt.savefig('./save/graph_average.png')
plt.show()
